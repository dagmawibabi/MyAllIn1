        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            image: DecorationImage(
              image: NetworkImage(isPoster == false
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => ImageViewerPage(
                                  isNetworkImage: true,
                                  networkImage: isPoster == false
                                      ? "https://image.tmdb.org/t/p/original" +
                                          widget.movieObject["backdrop_path"]
                                      : "https://image.tmdb.org/t/p/original" +
                                          widget.movieObject["poster_path"],
                                  title: widget.isSeries == true
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  // Flip between poster and backdrop image
                                  // IconButton(
                                  //   onPressed: () {
                                  //     isPoster = !isPoster;
                                  //     setState(() {});
                        ...
                        children: [
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    SizedBox(width: 8.0),
                                    Text(
                                      widget.movieObject["vote_average"]
                                          .toString(),
                                      style: TextStyle(
                                        color: Colors.grey[400],
                                        fontWeight: FontWeight.bold,
                          ...
                          widget.isSeries == false
                              ...
                              : Column(
                                  ...
                                  children: [
                                    Text(
                                      widget.movieObject["origin_country"]
                                                  .length >
                                              1
                                          ? "Origin Countries"
                                          : "Origin Country",
                                    ...
                                    Container(
                                      ...
                                      child: ListView(
                                        ...
                                        children: [
                                          Row(
                                            children: [
                                              for (var originCountry
                                                  in widget.movieObject[
                                                      "origin_country"])
                                                Container(
                                                  margin: EdgeInsets.only(
                                                      right: 10.0,
